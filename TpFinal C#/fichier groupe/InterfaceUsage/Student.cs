...
namespace InterfaceUsage
{
    public class Student : IPerson
    {
        ...
        public void visualiserIdentite()
        {
            Console.WriteLine(String.Format("Etudiant avec ID [{0}], Nom [{1}], Postnom [{2}], Numero Roll [{3}]", Id, FirstName, LastName, RollNumber));
        }

        public void visualiserdonnesIdentite(int id)
        {
