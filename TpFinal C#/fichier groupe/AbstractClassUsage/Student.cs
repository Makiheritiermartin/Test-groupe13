...
namespace AbstractClassUsage
{
    public class Student : Person
    {
        ...
        public override void visualiserIdentite()
        {
            Console.WriteLine(String.Format("Etudiant avec ID [{0}], Nom [{1}], Postnom [{2}], Numero ROll [{3}]", Id, FirstName, LastName, _rollNumber));
        }

        public override void VisualiserDonnesIdentite(int id)
        {
        ...
        public override int Ajouter(Person p)
        {
            int record = 0;
